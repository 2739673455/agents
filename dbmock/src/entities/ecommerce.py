...
class DimBrandInfoZip(Base):
    ...
    start_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="生效开始日期"
    )
    end_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="生效结束日期"
    )
    ...
    status: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="状态:1有效 0失效"
    )
    is_current: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否当前版本:0否 1是"
    )
...
class DimCategoryInfoZip(Base):
    ...
    category_level: Mapped[str] = mapped_column(
        String(16), nullable=False, comment="层级:一级/二级/三级"
    )
    parent_category_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="父类目ID"
    )
    parent_category_name: Mapped[Optional[str]] = mapped_column(
        String(128), comment="父类目名称"
    )
    root_category_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="一级类目ID"
    )
    root_category_name: Mapped[Optional[str]] = mapped_column(
        String(128), comment="一级类目名称"
    )
    is_leaf: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否叶子节点:0否 1是"
    )
    sort_order: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("'0'"), comment="排序"
    )
    category_path: Mapped[Optional[str]] = mapped_column(
        String(512), comment="类目路径"
    )
    status: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="状态:0禁用 1启用"
    )
    is_current: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否当前版本:0否 1是"
    )
...
class DimCouponInfoDf(Base):
    ...
    coupon_type: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="类型:满减券/折扣券/运费券/品类券"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    coupon_scope_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="适用范围:全平台/店铺/SPU/SKU/类目"
    )
    coupon_scope_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="适用范围ID"
    )
    threshold_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="使用门槛金额"
    )
    discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="减免金额"
    )
    discount_rate: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(8, 4), comment="折扣率"
    )
    max_discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="封顶优惠金额"
    )
    issue_start_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="发券开始时间"
    )
    issue_end_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="发券结束时间"
    )
    use_start_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="可用开始时间"
    )
    use_end_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="可用结束时间"
    )
    total_issue_cnt: Mapped[Optional[int]] = mapped_column(
        BigInteger, comment="总发行量"
    )
...
class DimGeoRegionZip(Base):
    ...
    region_level: Mapped[int] = mapped_column(
        TINYINT, nullable=False, comment="级别:1省 2市 3区县 4街道"
    )
    parent_region_code: Mapped[Optional[str]] = mapped_column(
        String(20), comment="父级区域编码"
    )
    parent_region_name: Mapped[Optional[str]] = mapped_column(
        String(128), comment="父级区域名称"
    )
...
class DimLogisticsCompanyZip(Base):
    ...
    logistics_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="物流类型:快递/同城/冷链/国际"
    )
    service_phone: Mapped[Optional[str]] = mapped_column(String(32), comment="客服电话")
    is_trace_supported: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否支持轨迹查询"
    )
    status: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="状态:1有效 0失效"
    )
...
class DimPaymentTypeZip(Base):
    ...
    channel_name: Mapped[Optional[str]] = mapped_column(
        String(64), comment="支付渠道名称"
    )
    is_online: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否线上支付"
    )
    is_installment: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否分期支付"
    )
    fee_rate: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(8, 6), comment="支付手续费率"
    )
    status: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="状态:1有效 0失效"
    )
...
class DimPromotionInfoDf(Base):
    ...
    promotion_type: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="活动类型:满减/折扣/秒杀/拼团"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    promotion_scene: Mapped[Optional[str]] = mapped_column(
        String(32), comment="活动场景:商品/店铺/平台"
    )
    promotion_level: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="活动优先级(数值越小优先级越高)"
    )
    start_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="生效开始时间"
    )
    end_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="生效结束时间"
    )
    rule_desc: Mapped[Optional[str]] = mapped_column(String(1024), comment="规则描述")
    threshold_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="门槛金额"
    )
    discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="减免金额"
    )
    ...
    max_discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="封顶减免"
    )
    sponsor_type: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="发起方:1平台 2店铺 3品牌"
    )
    sponsor_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="发起方ID"
    )
...
class DimShopInfoZip(Base):
    ...
    shop_type: Mapped[Optional[str]] = mapped_column(
        String(16),
        server_default=text("'普通店'"),
        comment="店铺类型:自营/旗舰店/专卖店/普通店",
    )
    seller_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="商家ID"
    )
    ...
    is_self_operated: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否自营:0否 1是"
    )
    is_global: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否跨境:0否 1是"
    )
    is_deleted: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="逻辑删除:0否 1是"
    )
    shop_status: Mapped[Optional[str]] = mapped_column(
        String(16), server_default=text("'营业'"), comment="状态:关店/营业"
    )
    is_current: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否当前版本:0否 1是"
    )
...
class DimSkuInfoZip(Base):
    ...
    category_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="三级类目ID"
    )
    brand_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="品牌ID"
    )
    ...
    unit: Mapped[Optional[str]] = mapped_column(
        String(16), server_default=text("'件'"), comment="单位"
    )
    origin_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="原价"
    )
    sale_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="销售价"
    )
    cost_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="成本价"
    )
    warning_stock: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("'0'"), comment="预警库存"
    )
    is_hot_sale: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否热销"
    )
    is_new: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否新品"
    )
    is_deleted: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="逻辑删除"
    )
    is_current: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否当前版本:0否 1是"
    )
...
class DimSpuInfoZip(Base):
    ...
    is_virtual: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否虚拟商品"
    )
    is_presale: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否预售"
    )
    ...
    presale_end_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="预售结束时间"
    )
    weight: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(12, 3), server_default=text("'0.000'"), comment="重量kg"
    )
    volume: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(12, 3), server_default=text("'0.000'"), comment="体积m3"
    )
    on_shelf_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="上架时间"
    )
    is_current: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否当前版本:0否 1是"
    )
...
class DimUserInfoZip(Base):
    ...
    gender: Mapped[Optional[str]] = mapped_column(
        String(8), server_default=text("'未知'"), comment="性别:未知/男/女"
    )
    ...
    register_source: Mapped[Optional[str]] = mapped_column(
        String(32), comment="注册来源(APP/H5/PC等)"
    )
    user_level: Mapped[Optional[str]] = mapped_column(
        String(16), server_default=text("'1'"), comment="会员等级"
    )
    user_tag: Mapped[Optional[str]] = mapped_column(String(128), comment="用户标签")
    is_vip: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否VIP:0否 1是"
    )
    province_code: Mapped[Optional[str]] = mapped_column(String(20), comment="省编码")
    city_code: Mapped[Optional[str]] = mapped_column(String(20), comment="市编码")
    ...
    user_status: Mapped[Optional[str]] = mapped_column(
        String(16), server_default=text("'正常'"), comment="状态:正常/禁用/注销"
    )
    is_current: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否当前版本:0否 1是"
    )
...
class DwdInteractionCartAddDi(Base):
    ...
    cart_add_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="加购明细ID(业务主键)"
    )
    sku_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="SKU ID"
    )
    add_sku_num: Mapped[int] = mapped_column(
        Integer, nullable=False, comment="加购件数"
    )
    event_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="加购时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    ...
    user_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="用户ID(游客为空)"
    )
    ...
    shop_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="店铺ID"
    )
    spu_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="SPU ID"
    )
    category_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="类目ID"
    )
    cart_source: Mapped[Optional[str]] = mapped_column(
        String(32), comment="加购来源:商品详情/搜索/推荐/活动页"
    )
    client_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="客户端类型:iOS/Android/H5/PC/小程序"
    )
    channel_code: Mapped[Optional[str]] = mapped_column(String(32), comment="渠道编码")
    sku_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="加购时单价"
    )
...
class DwdInteractionFavorAddDi(Base):
    ...
    id: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    favor_add_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="收藏明细ID(业务主键)"
    )
    user_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="用户ID"
    )
    favor_type: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="收藏类型:商品/店铺"
    )
    event_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="收藏时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    ...
    sku_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="SKU ID"
    )
    spu_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="SPU ID"
    )
...
class DwdInventoryChangeDi(Base):
    ...
    inventory_change_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="库存变更明细ID(业务主键)"
    )
    sku_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="SKU ID"
    )
    change_type: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="变更类型:入库/出库/锁定/解锁/盘点"
    )
    before_stock_qty: Mapped[int] = mapped_column(
        Integer, nullable=False, comment="变更前库存"
    )
    change_qty: Mapped[int] = mapped_column(
        Integer, nullable=False, comment="变更数量(可正可负)"
    )
    after_stock_qty: Mapped[int] = mapped_column(
        Integer, nullable=False, comment="变更后库存"
    )
    ...
    change_no: Mapped[Optional[str]] = mapped_column(
        String(64), comment="库存变更流水号"
    )
    spu_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="SPU ID"
    )
    ...
    warehouse_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="仓库ID"
    )
    biz_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="业务类型:下单/取消/发货/退款/调拨"
    )
    biz_id: Mapped[Optional[str]] = mapped_column(String(64), comment="业务单据ID")
    before_lock_qty: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("'0'"), comment="变更前锁定库存"
    )
    change_lock_qty: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("'0'"), comment="锁定库存变更量"
    )
    after_lock_qty: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("'0'"), comment="变更后锁定库存"
    )
    unit_cost: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 4), comment="单位成本"
    )
    total_cost_change: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 4), comment="总成本变动"
    )
    operator_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="操作人ID"
    )
    operator_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="操作人类型:系统/用户/商家/仓管"
    )
...
class DwdServiceCommentDetailDi(Base):
    ...
    comment_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="评价明细ID(业务主键)"
    )
    comment_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="评价ID"
    )
    order_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单ID"
    )
    order_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单明细ID"
    )
    user_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="用户ID"
    )
    ...
    comment_level: Mapped[int] = mapped_column(
        TINYINT, nullable=False, comment="评分(1-5)"
    )
    comment_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="评价时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    ...
    is_anonymous: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否匿名"
    )
    is_with_image: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否晒图"
    )
    is_with_video: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否晒视频"
    )
    is_append_comment: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否追评"
    )
    comment_content: Mapped[Optional[str]] = mapped_column(
        String(2000), comment="评价内容(可脱敏)"
    )
...
class DwdTradeDeliveryDetailDi(Base):
    ...
    id: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    delivery_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="发货明细ID(业务主键)"
    )
    delivery_no: Mapped[str] = mapped_column(
        String(64), nullable=False, comment="发货单号"
    )
    order_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单ID"
    )
    ...
    delivery_status: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="发货状态:待发货/已发货/运输中/已签收/拒收"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期(按发货日期)"
    )
    warehouse_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="仓库ID"
    )
    logistics_company_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="物流公司ID"
    )
    tracking_no: Mapped[Optional[str]] = mapped_column(String(128), comment="运单号")
    delivery_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="配送类型:快递/同城/门店自提"
    )
    receiver_name: Mapped[Optional[str]] = mapped_column(
        String(64), comment="收件人(脱敏)"
    )
    receiver_phone: Mapped[Optional[str]] = mapped_column(
        String(20), comment="收件电话(脱敏)"
    )
    receiver_province_code: Mapped[Optional[str]] = mapped_column(
        String(20), comment="收货省编码"
    )
    receiver_city_code: Mapped[Optional[str]] = mapped_column(
        String(20), comment="收货市编码"
    )
    receiver_district_code: Mapped[Optional[str]] = mapped_column(
        String(20), comment="收货区编码"
    )
    receiver_address: Mapped[Optional[str]] = mapped_column(
        String(512), comment="收货地址(脱敏)"
    )
    package_cnt: Mapped[Optional[int]] = mapped_column(
        Integer, server_default=text("'1'"), comment="包裹数量"
    )
    total_weight: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 3), server_default=text("'0.000'"), comment="总重量kg"
    )
    freight_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="运费金额"
    )
    outbound_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="出库时间"
    )
    delivery_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="发货时间"
    )
    sign_time: Mapped[Optional[datetime.datetime]] = mapped_column(
...
class DwdTradeOrderDetailActivityDi(Base):
    ...
    order_detail_activity_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单明细活动摊销ID"
    )
    order_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单明细ID"
    )
    ...
    promotion_discount_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="活动分摊金额"
    )
    order_create_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="下单时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    promotion_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="活动类型"
    )
    promotion_level: Mapped[Optional[int]] = mapped_column(
        TINYINT, comment="活动层级优先级"
    )
    rule_snapshot: Mapped[Optional[str]] = mapped_column(
        String(1024), comment="规则快照"
    )
...
class DwdTradeOrderDetailCouponDi(Base):
    ...
    order_detail_coupon_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单明细优惠券摊销ID"
    )
    order_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单明细ID"
    )
    ...
    coupon_discount_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="优惠券分摊金额"
    )
    order_create_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="下单时间"
    )
    ...
    coupon_user_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="领券用户ID"
    )
    coupon_type: Mapped[Optional[str]] = mapped_column(String(32), comment="券类型")
    coupon_scope_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="券适用范围"
    )
    coupon_batch_no: Mapped[Optional[str]] = mapped_column(
        String(64), comment="券批次号"
    )
    coupon_receive_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="领券时间"
    )
    coupon_use_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="用券时间"
    )
...
class DwdTradeOrderDetailDi(Base):
    ...
    id: Mapped[int] = mapped_column(BIGINT(unsigned=True), primary_key=True)
    order_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单明细ID(业务主键)"
    )
    order_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单ID"
    )
    order_status: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="订单状态"
    )
    user_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="用户ID"
    )
    ...
    order_detail_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="明细总金额(不含优惠)"
    )
    payable_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="应付金额"
    )
    order_create_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="下单时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期(按下单日期)"
    )
    parent_order_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="父订单ID(拆单场景)"
    )
    ...
    order_source: Mapped[Optional[str]] = mapped_column(
        String(32), comment="下单来源:APP/H5/PC/小程序"
    )
    order_scene: Mapped[Optional[str]] = mapped_column(
        String(32), comment="订单场景:普通/秒杀/拼团/预售"
    )
    seller_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="商家ID"
    )
    ...
    is_first_order: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否首单"
    )
    is_cross_border: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否跨境"
    )
    is_pre_sale: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否预售"
    )
    is_gift: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否赠品"
    )
    is_risk_order: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否风控单"
    )
    is_order_finish: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="订单是否完结:0否 1是"
    )
    sku_origin_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="SKU原价"
    )
    sku_sale_price: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), comment="SKU成交单价"
    )
    activity_discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="活动优惠金额"
    )
    coupon_discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="优惠券优惠金额"
    )
    points_discount_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="积分抵扣金额"
    )
    freight_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="运费"
    )
    tax_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="税费"
    )
    paid_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="实付金额"
    )
    cost_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="成本金额"
    )
    order_pay_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="支付时间"
    )
    order_delivery_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="发货时间"
    )
    order_receive_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="收货时间"
    )
    order_cancel_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="取消时间"
    )
    cancel_stage: Mapped[Optional[str]] = mapped_column(
        String(32), comment="取消阶段:未支付取消/支付后取消/拒收"
    )
...
class DwdTradePayDetailDi(Base):
    ...
    pay_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="支付明细ID(业务主键)"
    )
    ...
    pay_status: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="支付状态:成功/失败/关闭"
    )
    total_pay_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="支付总金额"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期(按支付日期)"
    )
    ...
    payment_channel_code: Mapped[Optional[str]] = mapped_column(
        String(32), comment="支付渠道编码"
    )
    pay_scene: Mapped[Optional[str]] = mapped_column(
        String(32), comment="支付场景:收银台/自动扣款/合并支付"
    )
    currency_code: Mapped[Optional[str]] = mapped_column(
        String(8), server_default=text("'CNY'"), comment="币种"
    )
    cash_pay_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="现金支付金额"
    )
    coupon_pay_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="券抵扣金额"
    )
    points_pay_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="积分抵扣金额"
    )
    balance_pay_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="余额支付金额"
    )
    installment_cnt: Mapped[Optional[int]] = mapped_column(Integer, comment="分期期数")
    installment_fee_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="分期手续费"
    )
    pay_success_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="支付成功时间"
    )
    pay_fail_reason: Mapped[Optional[str]] = mapped_column(
        String(512), comment="支付失败原因"
    )
...
class DwdTradeRefundDetailDi(Base):
    ...
    refund_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="退款明细ID(业务主键)"
    )
    ...
    refund_type: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="退款类型:仅退款/退货退款"
    )
    refund_status: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="退款状态"
    )
    refund_apply_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="申请退款金额"
    )
    apply_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="申请时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期(按申请日期)"
    )
    refund_reason_code: Mapped[Optional[str]] = mapped_column(
        String(32), comment="退款原因编码"
    )
    refund_reason_desc: Mapped[Optional[str]] = mapped_column(
        String(256), comment="退款原因描述"
    )
    refund_approve_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="审核通过退款金额"
    )
    refund_success_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="退款成功金额"
    )
    refund_freight_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="退运费金额"
    )
    refund_tax_amount: Mapped[Optional[decimal.Decimal]] = mapped_column(
        DECIMAL(16, 2), server_default=text("'0.00'"), comment="退税金额"
    )
    is_quality_issue: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否质量问题"
    )
    need_return_goods: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否需要退货"
    )
    return_tracking_no: Mapped[Optional[str]] = mapped_column(
        String(128), comment="退货运单号"
    )
    audit_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="审核时间"
    )
    receive_return_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="商家收货时间"
    )
    refund_success_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="退款成功时间"
    )
    close_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="退款关闭时间"
    )
...
class DwdTradeRefundPayDetailDi(Base):
    ...
    refund_pay_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="退款支付明细ID(业务主键)"
    )
    refund_no: Mapped[str] = mapped_column(
        String(64), nullable=False, comment="退款单号"
    )
    refund_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="退款明细ID"
    )
    order_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="订单ID"
    )
    ...
    payment_type_code: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="原支付方式编码"
    )
    refund_status: Mapped[str] = mapped_column(
        String(32), nullable=False, comment="退款打款状态"
    )
    refund_amount: Mapped[decimal.Decimal] = mapped_column(
        DECIMAL(16, 2), nullable=False, comment="退款金额"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期(按退款到账日期)"
    )
    pay_detail_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="原支付明细ID"
    )
    refund_channel_code: Mapped[Optional[str]] = mapped_column(
        String(32), comment="退款渠道编码"
    )
    refund_account_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="退款账户类型"
    )
    refund_apply_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="退款申请时间"
    )
    refund_pay_time: Mapped[Optional[datetime.datetime]] = mapped_column(
        DateTime, comment="退款到账时间"
    )
    refund_fail_reason: Mapped[Optional[str]] = mapped_column(
        String(512), comment="退款失败原因"
    )
...
class DwdTrafficPageViewDi(Base):
    ...
    page_view_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="页面访问明细ID(业务主键)"
    )
    page_id: Mapped[str] = mapped_column(String(64), nullable=False, comment="页面ID")
    event_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="访问时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    ...
    last_page_id: Mapped[Optional[str]] = mapped_column(
        String(64), comment="上一个页面ID"
    )
    page_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="页面类型:首页/详情/活动/搜索/下单"
    )
    business_id: Mapped[Optional[str]] = mapped_column(
        String(64), comment="业务实体ID(如 sku_id/spu_id/activity_id)"
    )
    business_type: Mapped[Optional[str]] = mapped_column(
        String(32), comment="业务实体类型"
    )
    channel_code: Mapped[Optional[str]] = mapped_column(String(32), comment="渠道编码")
    client_type: Mapped[Optional[str]] = mapped_column(String(32), comment="客户端类型")
    ...
    province_code: Mapped[Optional[str]] = mapped_column(
        String(20), comment="访问省编码"
    )
    city_code: Mapped[Optional[str]] = mapped_column(String(20), comment="访问市编码")
    stay_duration_sec: Mapped[Optional[int]] = mapped_column(
        Integer, comment="停留秒数"
    )
    is_bounce: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否跳出"
    )
...
class DwdTrafficSearchDi(Base):
    ...
    search_detail_id: Mapped[int] = mapped_column(
        BIGINT(unsigned=True), nullable=False, comment="搜索明细ID(业务主键)"
    )
    search_keyword: Mapped[str] = mapped_column(
        String(256), nullable=False, comment="搜索词"
    )
    event_time: Mapped[datetime.datetime] = mapped_column(
        DateTime, nullable=False, comment="搜索时间"
    )
    etl_date: Mapped[datetime.date] = mapped_column(
        Date, nullable=False, comment="分区日期"
    )
    ...
    search_source: Mapped[Optional[str]] = mapped_column(
        String(32), comment="搜索入口:首页/分类页/店铺页"
    )
    result_total_cnt: Mapped[Optional[int]] = mapped_column(
        Integer, comment="搜索结果总数"
    )
    click_rank: Mapped[Optional[int]] = mapped_column(Integer, comment="点击结果位次")
    click_sku_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="点击SKU ID"
    )
    click_spu_id: Mapped[Optional[int]] = mapped_column(
        BIGINT(unsigned=True), comment="点击SPU ID"
    )
    is_no_result: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'0'"), comment="是否无结果"
    )
    is_search_success: Mapped[Optional[int]] = mapped_column(
        TINYINT, server_default=text("'1'"), comment="是否成功返回结果"
    )
    channel_code: Mapped[Optional[str]] = mapped_column(String(32), comment="渠道编码")
    client_type: Mapped[Optional[str]] = mapped_column(String(32), comment="客户端类型")
