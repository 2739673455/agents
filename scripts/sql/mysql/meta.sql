...
(
    ...
    role VARCHAR(256) NOT NULL COMMENT '表类型(fact/dim)',
    description TEXT NOT NULL COMMENT '表描述',
...
(
    ...
    type VARCHAR(256) NOT NULL COMMENT '数据类型',
    description TEXT NOT NULL COMMENT '列描述',
    alias JSON NOT NULL COMMENT '列别名',
    examples JSON NOT NULL COMMENT '数据示例',
